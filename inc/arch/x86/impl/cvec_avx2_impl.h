...
// mul
CVEC_FORCE_INLINE vi16 mul_vi16(const vi16 lhs, const vi16 rhs) { return _mm256_mullo_epi16(lhs, rhs); }
CVEC_FORCE_INLINE vi32 mul_vi32(const vi32 lhs, const vi32 rhs) { return _mm256_mullo_epi32(lhs, rhs); }
